...
-------------------------------------------------------------------------
"
pacstrap /mnt base base-devel linux-zen linux-firmware vim nano sudo archlinux-keyring wget libnewt --noconfirm --needed --color=always
